// api/lifecycle/action.js
 ...
 export default async function handler(req, res) {
 	...
 	try {
 		...
 		const action = await prisma.action.create({ data: { creativeId, type, reasonShort: reasonShort||'', reasonDetail: reasonDetail||'', decidedBy: 'human', inputsJson: inputsJson || {} } })
